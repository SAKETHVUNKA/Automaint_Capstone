...
def train_stacked_model(X_train, y_train, n_trials=450):
    # Create individual models
    xgb_model = XGBRegressor(n_estimators=n_trials, learning_rate=0.01, random_state=168)
    lgbm_model = LGBMRegressor(n_estimators=n_trials, learning_rate=0.01, random_state=168)
    gbr_model = GradientBoostingRegressor(n_estimators=n_trials, learning_rate=0.01, random_state=168)
    rf_model = RandomForestRegressor(n_estimators=n_trials, random_state=168)
    ...
    stacking_regressor = StackingRegressor(
        ...
        final_estimator = LGBMRegressor(n_estimators=n_trials, learning_rate=0.01, random_state=168)
    )
