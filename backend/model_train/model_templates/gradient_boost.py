...
def train_gb(X_train, y_train, n_trials=50):
    ...
    def objective_gbm(trial):
        ...
        # Create the GradientBoostingRegressor model with suggested hyperparameters
    ...
    study_gbm.optimize(objective_gbm, n_trials=n_trials)

    # Get the best hyperparameters
    best_params = study_gbm.best_params
...
def main():
    ...
    try :
        ...
        # Fit the model
        model , best_params = train_gb(X_train,y_train)
        print("Model trained.")
